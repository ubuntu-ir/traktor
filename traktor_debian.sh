...
# Traktor GUI Panel 
mkdir $HOME/.traktor_gui_panel mv traktor_gui_panel.py $HOME/.traktor_gui_panel 
mv photos $HOME/.traktor_gui_panel/photos 
...
Icon=$HOME/.traktor_gui_panel/photos/tor.png
